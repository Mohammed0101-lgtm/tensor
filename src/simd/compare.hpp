...
template<class _Tp>
tensor<bool> internal::neon::equal(const tensor<_Tp>& t, const tensor<_Tp>& other) {
...
template<class _Tp>
tensor<bool> internal::neon::equal(const tensor<_Tp>& t, const _Tp value) {
    if constexpr (!internal::types::has_equal_operator_v<_Tp>)
    {
        throw error::operator_error("Value type must have equal to operator");
    }
...
template<class _Tp>
tensor<bool> internal::neon::less_equal(const tensor<_Tp>& t, const tensor<_Tp>& other) {
...
template<class _Tp>
tensor<bool> internal::neon::less_equal(const tensor<_Tp>& t, const _Tp value) {
...
template<class _Tp>
tensor<bool> internal::neon::greater(const tensor<_Tp>& t, const _Tp value) {
...
template<class _Tp>
tensor<bool> internal::neon::greater(const tensor<_Tp>& t, const tensor<_Tp>& other) {
    if constexpr (!internal::types::has_greater_operator_v<_Tp>)
    {
        throw error::operator_error("Value type must have greater than operator");
    }
...
template<class _Tp>
tensor<bool> internal::neon::greater_equal(const tensor<_Tp>& t, const _Tp value) {
...
template<class _Tp>
tensor<bool> internal::neon::greater_equal(const tensor<_Tp>& t, const tensor<_Tp>& other) {
    if constexpr (!internal::types::has_greater_equal_operator_v<_Tp>)
    {
        throw error::operator_error("Value type must have greater than or equal to operator");
    }
...
template<class _Tp>
tensor<bool> internal::neon::not_equal(const tensor<_Tp>& t, const _Tp value) {
...
template<class _Tp>
tensor<bool> internal::neon::not_equal(const tensor<_Tp>& t, const tensor<_Tp>& other) {
...
template<class _Tp>
inline tensor<bool> internal::neon::less(const tensor<_Tp>& t, const _Tp value) {
...
template<class _Tp>
inline tensor<bool> internal::neon::less(const tensor<_Tp>& t, const tensor<_Tp>& other) {
