...
int main() {
  std::string filename = "multiplication_test_results.csv";
  ...
  for (int i = 0, num_iterations = 120; i < num_iterations; ++i)
  {
    ...
    tensor<float> my_result = my_tensor * my_tensor2;
    ...
    std::cout << "Eigen duration      = " << eigen_duration << " microseconds" << std::endl;
    std::cout << "My library duration = " << my_duration << " microseconds" << std::endl;
    std::cout << "xtensor duration    = " << xt_duration << " microseconds" << std::endl;
