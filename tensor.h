...
class _LIBCPP_TEMPLATE_VIS tensor {
 ...
 public:
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> sum(const index_type __axis) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> row(const index_type __index) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> col(const index_type __index) const;
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type>
  clamp(const value_type* __min_val = nullptr, const value_type* __max_val = nullptr) const;
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> logical_xor(const value_type __val) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI                    tensor<value_type>
                                                      logical_and(const tensor<value_type>& __other) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> logical_and(const value_type __val) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> bitwise_not() const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> bitwise_and(const value_type __val) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI                    tensor<value_type>
                                                      bitwise_and(const tensor<value_type>& __other) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> bitwise_or(const value_type __val) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI                    tensor<value_type>
                                                      bitwise_or(const tensor<value_type>& __other) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> bitwise_xor(const value_type __val) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI                    tensor<value_type>
                                                      bitwise_xor(const tensor<value_type>& __other) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> bitwise_left_shift(const int __amount) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> bitwise_right_shift(const int __amount) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI                    tensor<value_type>
                                                      matmul(const tensor<value_type>& __other) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> reshape(const shape_type __shape) const;
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type>
                                                      absolute(const tensor<value_type>& __tensor) const;
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> pow(const value_type __val) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> cumprod(index_type __dim = -1) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI                    tensor<value_type>
  cat(const std::vector<tensor<value_type>>& _others, index_type _dim) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> argmax(index_type __dim) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<value_type> unsqueeze(index_type __dim) const;
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void clamp_(const value_type* __min_val = nullptr,
                                                                  const value_type* __max_val = nullptr);
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void logical_or_(const value_type __val) {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void logical_xor_(const value_type __val) {
    if (!std::is_integral<value_type>::value && !std::is_same<value_type, bool>::value)
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void logical_and_(const value_type __val) {
    if (!std::is_integral<value_type>::value && !std::is_same<value_type, bool>::value)
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void pow_(const value_type __val) const {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void bitwise_left_shift_(const int __amount) {
    this->__check_is_integral_type("Cannot perform a bitwise left shift on non-integral values");
    size_t __i = 0;
    for (; __i < this->__data_.size(); __i++)
      this->__data_[__i] <<= __amount;
  }
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void bitwise_right_shift_(const int __amount) {
    this->__check_is_integral_type("Cannot perform a bitwise right shift on non-integral values");
    size_t __i = 0;
    for (; __i < this->__data_.size(); __i++)
      this->__data_[__i] >>= __amount;
  }
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void bitwise_and_(const value_type __val) {
    if (!std::is_integral<value_type>::value && !std::is_same<value_type, bool>::value)
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void bitwise_or_(const value_type __val) {
    if (!std::is_integral<value_type>::value && !std::is_same<value_type, bool>::value)
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void bitwise_xor_(const value_type __val) {
    if (!std::is_integral<value_type>::value && !std::is_same<value_type, bool>::value)
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void view(std::initializer_list<index_type> __new_sh);
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI void print() const _NOEXCEPT;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI static tensor<value_type> zeros(const shape_type& __sh) {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI static tensor<value_type> ones(const shape_type& __sh) {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI static tensor<value_type>
                                randomize(const shape_type& __sh, bool __bounded = false) _NOEXCEPT;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<index_type> argmax_(index_type __dim) const;
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI tensor<index_type> argsort(index_type __dim       = -1LL,
                                                                                 bool       __ascending = true) const;
 ...
 private:
  ...
  __compute_index(const std::vector<index_type>& __idx) const {
  ...
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI uint64_t __computeSize(const shape_type& __dims) const {
    uint64_t __ret = 0ULL;
    for (const index_type& __d : _dims)
      __ret *= __d;
    return __ret;
  }
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI float __frac(const reference __scalar) {
    return std::fmod(static_cast<float>(scalar), 1.0lf);
  }
  _LIBCPP_CONSTEXPR_SINCE_CXX20 _LIBCPP_HIDE_FROM_ABI index_type __lcm(const index_type __a, const index_type __b) {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::operator+(const tensor<_Tp>::value_type __scalar) const {
  this->__check_is_arithmetic_type("template class must be an arithmetic type");
  size_t __i = 0;
  for (; __i < this->__data_.size(); __i++)
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::randomize(const shape_type& __sh,
                                                                 bool              __bounded = false) _NOEXCEPT {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<typename tensor<_Tp>::index_type> tensor<_Tp>::argmax_(index_type __dim) const {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::argmax(index_type __dim) const {
  if (__dim < 0 || __dim >= this->__shape_.size())
    throw std::out_of_range("Dimension out of range in argmax");
  shape_type __ret_sh = this->__shape_;
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::unsqueeze(index_type __dim) const {
  if (__dim < 0 || __dim > static_cast<index_type>(this->__shape_.size()))
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 void tensor<_Tp>::view(std::initializer_list<index_type> __sh) {
  index_type __s = 1LL;
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::cat(const std::vector<tensor<_Tp>>& __others,
                                                           index_type                      __dim) const {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::cumprod(index_type __dim = -1) const {
  if (__dim == -1) {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::slice(index_type                __dim,
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 size_t tensor<_Tp>::count_nonzero(index_type __dim = -1LL) const {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::reshape(const shape_type __sh) const {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::absolute(const tensor<tensor<_Tp>::value_type>& __tensor) const {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::bitwise_left_shift(const int __amount) const {
  this->__check_is_integral_type("Cannot perform a bitwise left shift on non-integral values");
  data_container __ret(this->__data_.size());
  size_t         __i = 0;
  for (; __i < this->__data_.size(); __i++)
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<bool> tensor<_Tp>::logical_or(const tensor<_Tp>::value_type __val) const {
  if (!std::is_integral<tensor<_Tp>::value_type>::value && !std::is_same<tensor<_Tp>::value_type, bool>::value)
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::logical_xor(const tensor<_Tp>::value_type __val) const {
  if (!std::is_integral<tensor<_Tp>::value_type>::value && !std::is_same<tensor<_Tp>::value_type, bool>::value)
    throw std::runtime_error("Cannot get the element wise xor of non-integral and non-boolean value");
  assert(this->__shape_ == __other.shape());
  std::vector<bool> __ret(this->__data_.size());
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::logical_and(const tensor<_Tp>::value_type __val) const {
  if (!std::is_integral<tensor<_Tp>::value_type>::value && !std::is_same<tensor<_Tp>::value_type, bool>::value)
    throw std::runtime_error("Cannot get the element wise and of non-integral and non-boolean value");
  std::vector<bool> __ret(this->__data_.size());
  size_t            __i = 0;
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::pow(const tensor<_Tp>::value_type __val) const {
  this->__check_is_integral_type("cannot get the power of a non integral value");
  data_container __ret(this->__data_.size());
  size_t         __i = 0;
  for (; __i < this->__data_.size(); __i++)
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<bool> tensor<_Tp>::less_equal(const tensor<_Tp>::value_type __val) const {
  if (!std::is_integral<tensor<_Tp>::value_type>::value && !std::is_scalar<tensor<_Tp>::value_type>::value)
    throw std::runtime_error("Cannot compare non-integral or scalar value");
  std::vector<bool> __ret(this->__data_.size());
  size_t            __i = 0;
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<bool> tensor<_Tp>::greater_equal(const tensor<_Tp>::value_type __val) const {
  if (!std::is_integral<tensor<_Tp>::value_type>::value && !std::is_scalar<tensor<_Tp>::value_type>::value)
    throw std::runtime_error("Cannot compare non-integral or scalar value");
  std::vector<bool> __ret(this->__data_.size());
  size_t            __i = 0;
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<bool> tensor<_Tp>::equal(const tensor<_Tp>::value_type __val) const {
  if (!std::is_integral<tensor<_Tp>::value_type>::value && !std::is_scalar<tensor<_Tp>::value_type>::value)
    throw std::runtime_error("Cannot compare non-integral or scalar value");
  std::vector<bool> __ret(this->__data_.size());
  size_t            __i = 0;
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::sum(const index_type __axis) const {
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::row(const index_type __index) const {
  if (this->__shape_.size() != 2)
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::col(const index_type __index) const {
  if (this->__shape_.size() != 2)
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 tensor<_Tp> tensor<_Tp>::clamp(const tensor<_Tp>::value_type* __min_val = nullptr,
...
template<class _Tp>
_LIBCPP_CONSTEXPR_SINCE_CXX20 void tensor<_Tp>::clamp_(const tensor<_Tp>::value_type* __min_val = nullptr,
